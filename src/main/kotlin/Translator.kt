        ...
        javaClass.getResourceAsStream("/translate.tsv")!!.use {
            BufferedReader(InputStreamReader(it)).use { reader ->
                ...
                mapOf(
                    ...
                    "Pantheon of the Master to Level" to "大师万神殿",
                    "Pantheon of the Artist to Level" to "艺术家万神殿",
                    "Pantheon of the Sage to Level" to "贤者万神殿",
                    "Pantheon of the Knight to Level" to "骑士万神殿",
                    "Pantheon of Hallownest to Level" to "圣巢万神殿",
                    "White Palace to Level" to "白色宫殿",
                    "Path of Pain to Level" to "苦痛之路",
                    "Trial of the Warrior to Level" to "勇士的试炼",
                    "Trial of the Conqueror to Level" to "征服者的试炼",
                    "Trial of the Fool to Level" to "愚人的试炼",
                    "NMG." to "无主要邪道.",
                    "- NMG" to "- 无主要邪道",
                    "- NMG." to "- 无主要邪道.",
